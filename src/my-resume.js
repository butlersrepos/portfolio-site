	...
	"bio_data": {
		...
		"experience": {
			...
			"projects": [
				{
					"client": "Bitbucket",
					"client_link": "https://bitbucket.org",
					"location": "San Francisco, CA",
					"start": "September 2017",
					"end": "Present",
					"project": "Code Review",
					"description": "Separating the code review process on Bitbucket from the main application into a SPA using a modern React tech stack."
				},
				{
					"client": "OhioHealth",
